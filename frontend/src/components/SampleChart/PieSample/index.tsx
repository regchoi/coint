...
import SampleDataPieChart from "./SampleDataPieChart";
            ...
            <Grid container style={{height: '90vh', width: 'calc(100vw - 300px)'}}>
                {
                    ...
                    // TODO: anchorEl가 1이면 ChartA, 2이면 ChartB, 3이면 ChartC를 렌더링
                    // anchorEl이 1, 2, 3이 아니면 아무것도 렌더링하지 않음
                    anchorPosition === 1 ? <ChartA data={data}></ChartA> :
                        anchorPosition === 2 ? <ChartB data={data} /> :
                        //     anchorEl === 3 ? <ChartC data={data} /> :
                        //      SampleData를 활용한 Pie Chart
                                <SampleDataPieChart />
                }
            </Grid>
