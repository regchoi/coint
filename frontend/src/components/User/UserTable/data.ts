...
const headCells: readonly HeadCell[] = [
    {id: 'id_num', numeric: true, disablePadding: false, label: 'Seq'},
    {id: 'login_id', numeric: false, disablePadding: false, label: '아이디'},
    ...
    {id: 'group_name', numeric: false, disablePadding: false, label: '권한'},
    {id: 'phone', numeric: false, disablePadding: false, label: '전화번호'},
    {id: 'reg_date', numeric: false, disablePadding: false, label: '등록일'},
    {id: 'reg_userid', numeric: false, disablePadding: false, label: '등록자'},
];
