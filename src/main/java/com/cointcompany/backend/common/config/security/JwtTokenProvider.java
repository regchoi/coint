...
//import com.cointcompany.backend.domain.auth.service.AuthDetailsService;
...
//            AuthDetailsService userDetailsService,
...
//        String userId = getClaims(token).get(USER_ID).toString();
//        UserDetails userDetailsImpl = userDetailsService.loadUserByUsername(userId);
